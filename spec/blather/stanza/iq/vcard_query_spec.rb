...
describe Blather::Stanza::Iq::VcardQuery do
  it 'registers itself' do
    Blather::XMPPNode.class_from_registration(:vCard, 'vcard-temp').must_equal Blather::Stanza::Iq::VcardQuery
  end

  it 'can be imported' do
    doc = parse_stanza vcard_xml
    query = Blather::XMPPNode.import(doc.root)
    query.must_be_instance_of Blather::Stanza::Iq::VcardQuery
    query.vcard.must_be_instance_of Blather::Stanza::Iq::VcardQuery::Vcard
  end

  it 'ensures a vcard node is present on create' do
    query = Blather::Stanza::Iq::VcardQuery.new
  ...
  it 'ensures a vcard node is replaced when calling #vcard=' do
    ...
    new_vcard = Blather::Stanza::Iq::VcardQuery::Vcard.new
...
describe Blather::Stanza::Iq::VcardQuery::Vcard do
  it 'can set vcard elements' do
    query = Blather::Stanza::Iq::VcardQuery.new :set
