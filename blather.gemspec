...
Gem::Specification.new do |s|
  ...
  s.files = [
    "examples/echo.rb",
     ...
     "lib/blather/client/client.rbc",
     "lib/blather/client/dsl.rb",
     "lib/blather/client/dsl.rbc",
     "lib/blather/client/dsl/pubsub.rb",
     "lib/blather/client/dsl/pubsub.rbc",
     "lib/blather/core_ext/active_support.rb",
     "lib/blather/core_ext/active_support.rbc",
     "lib/blather/core_ext/active_support/inheritable_attributes.rb",
     "lib/blather/core_ext/active_support/inheritable_attributes.rbc",
     "lib/blather/core_ext/nokogiri.rb",
     "lib/blather/core_ext/nokogiri.rbc",
     "lib/blather/errors.rb",
     "lib/blather/errors.rbc",
     "lib/blather/errors/sasl_error.rb",
     "lib/blather/errors/sasl_error.rbc",
     "lib/blather/errors/stanza_error.rb",
     "lib/blather/errors/stanza_error.rbc",
     "lib/blather/errors/stream_error.rb",
     "lib/blather/errors/stream_error.rbc",
     "lib/blather/jid.rb",
     "lib/blather/jid.rbc",
     "lib/blather/roster.rb",
     "lib/blather/roster.rbc",
     "lib/blather/roster_item.rb",
     "lib/blather/roster_item.rbc",
     "lib/blather/stanza.rb",
     "lib/blather/stanza.rbc",
     "lib/blather/stanza/disco.rb",
     "lib/blather/stanza/disco.rbc",
     "lib/blather/stanza/disco/disco_info.rb",
     "lib/blather/stanza/disco/disco_info.rbc",
     "lib/blather/stanza/disco/disco_items.rb",
     "lib/blather/stanza/disco/disco_items.rbc",
     "lib/blather/stanza/iq.rb",
     "lib/blather/stanza/iq.rbc",
     "lib/blather/stanza/iq/query.rb",
     "lib/blather/stanza/iq/query.rbc",
     "lib/blather/stanza/iq/roster.rb",
     "lib/blather/stanza/iq/roster.rbc",
     "lib/blather/stanza/message.rb",
     "lib/blather/stanza/message.rbc",
     "lib/blather/stanza/presence.rb",
     "lib/blather/stanza/presence.rbc",
     "lib/blather/stanza/presence/status.rb",
     "lib/blather/stanza/presence/status.rbc",
     "lib/blather/stanza/presence/subscription.rb",
     "lib/blather/stanza/presence/subscription.rbc",
     "lib/blather/stanza/pubsub.rb",
     "lib/blather/stanza/pubsub.rbc",
     "lib/blather/stanza/pubsub/affiliations.rb",
     "lib/blather/stanza/pubsub/affiliations.rbc",
     "lib/blather/stanza/pubsub/create.rb",
     "lib/blather/stanza/pubsub/create.rbc",
     "lib/blather/stanza/pubsub/errors.rb",
     "lib/blather/stanza/pubsub/event.rb",
     "lib/blather/stanza/pubsub/event.rbc",
     "lib/blather/stanza/pubsub/items.rb",
     "lib/blather/stanza/pubsub/items.rbc",
     "lib/blather/stanza/pubsub/publish.rb",
     "lib/blather/stanza/pubsub/publish.rbc",
     "lib/blather/stanza/pubsub/retract.rb",
     "lib/blather/stanza/pubsub/retract.rbc",
     "lib/blather/stanza/pubsub/subscribe.rb",
     "lib/blather/stanza/pubsub/subscribe.rbc",
     "lib/blather/stanza/pubsub/subscription.rb",
     "lib/blather/stanza/pubsub/subscription.rbc",
     "lib/blather/stanza/pubsub/subscriptions.rb",
     "lib/blather/stanza/pubsub/subscriptions.rbc",
     "lib/blather/stanza/pubsub/unsubscribe.rb",
     "lib/blather/stanza/pubsub/unsubscribe.rbc",
     "lib/blather/stanza/pubsub_owner.rb",
     "lib/blather/stanza/pubsub_owner.rbc",
     "lib/blather/stanza/pubsub_owner/delete.rb",
     "lib/blather/stanza/pubsub_owner/delete.rbc",
     "lib/blather/stanza/pubsub_owner/purge.rb",
     "lib/blather/stanza/pubsub_owner/purge.rbc",
     "lib/blather/stream.rb",
     "lib/blather/stream.rbc",
     "lib/blather/stream/client.rb",
     "lib/blather/stream/client.rbc",
     "lib/blather/stream/component.rb",
     "lib/blather/stream/component.rbc",
     "lib/blather/stream/features.rb",
     "lib/blather/stream/features.rbc",
     "lib/blather/stream/features/resource.rb",
     "lib/blather/stream/features/resource.rbc",
     "lib/blather/stream/features/sasl.rb",
     "lib/blather/stream/features/sasl.rbc",
     "lib/blather/stream/features/session.rb",
     "lib/blather/stream/features/session.rbc",
     "lib/blather/stream/features/tls.rb",
     "lib/blather/stream/features/tls.rbc",
     "lib/blather/stream/parser.rb",
     "lib/blather/stream/parser.rbc",
     "lib/blather/xmpp_node.rb",
     "lib/blather/xmpp_node.rbc"
  ]
